    ...
    try{$MadelineProto->messages->getPeerDialogs(['peers' => [$user]]);
        $x++;
                ...
                try{$MadelineProto->account->updateUsername(['username'=>$user]);
                    ...
                    file_get_contents("https://api.telegram.org/bot6539555682:AAE6rBOS6OtHWg6j3BiV9PaMdjdhdjdrmm2lAA/sendvideo?chat_id=-1001886866124&video=https://telegra.ph/file/af31cfdaa06f90868a714.mp4&caption=".urlencode($caption));
