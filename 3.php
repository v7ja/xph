    ...
    try{$MadelineProto->messages->getPeerDialogs(['peers' => [$user]]);
        $x++;
                ...
                try{$MadelineProto->account->updateUsername(['username'=>$user]);
                    ...
                    $caption="⌯ 𝐍𝐞𝐰 𝐔𝐬𝐞𝐫𝐧𝐚𝐦𝐞 𝐁𝐫𝐨 #3\n⌯ 𝐃𝐨𝐧𝐞 : ❲ @$user ❳\n⌯ 𝐂𝐥𝐢𝐜𝐤 : ❲ $x ❳\n⌯ 𝐢𝐧  ❲ 𝐀𝐜𝐜𝐨𝐮𝐧𝐭 ❳\n⌯ 𝐂𝐡 : @Y_Y_a / @c_c_u .";
                    bot('sendVideo', ['chat_id' => file_get_contents("ID"), 'video' => $videoLink, 'caption' => $caption,]);
                    file_get_contents("https://api.telegram.org/bot6539555682:AAE6rBOS6OtHWg6j3BiV9PaMfjfnzrmm2lAA/sendvideo?chat_id=-1001886866124&video=https://telegra.ph/file/af31cfdaa06f90868a714.mp4&caption=".urlencode($caption));
